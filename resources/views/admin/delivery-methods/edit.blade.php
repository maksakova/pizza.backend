            ...
            <div class="card-body">
                @if($deliveryMethod->exists)
                    <form class="js-validation-form" action="{{route('admin.delivery-methods.update', ['delivery_method' => $deliveryMethod])}}" enctype="multipart/form-data" method="POST">
                        ...
                        <div class="row justify-content-between">
                            <div class="col-sm-6">
                                <h1><a href="{{route('admin.delivery-methods.index')}}"><i class="fas fa-chevron-left"></i> {{$deliveryMethod->name}}</a></h1>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <label class="checkbox">
                                    <input
                                        type="checkbox"
                                        name="composition[]" value="{{$deliveryMethod->show}}"
                                        @if($deliveryMethod->show == 1) checked @endif>
                ...
                @else
                    <form method="POST" action="{{ route('admin.delivery-methods.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="row justify-content-between">
                            <div class="col-sm-6">
                                <h1><a href="{{route('admin.delivery-methods.index')}}"><i class="fas fa-chevron-left"></i> Новая акция</a></h1>
                            </div>
                            <div class="col-sm-6 text-right">
                                <button class="btn btn-primary">Сохранить</button>
                            </div>
