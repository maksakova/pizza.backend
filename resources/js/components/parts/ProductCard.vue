<template>
  <div class="col-lg-4 col-sm-6 product-item__outer">
    <div class="product-item">
      <div class="product-item__image" :class="item.pizzacat_name" :style="{ backgroundImage: 'url(' + item.img + ')' }"></div>
...
.product-item
  ...
  &__image
    ...
    &.veg
      &:after
        content: url("~@/assets/img/common/product-veg-small.svg")
        position: absolute
        top: 8px
        right: 7px
    &.hot
      &:after
        content: url("~@/assets/img/common/product-hot-small.svg")
        position: absolute
        top: 8px
        right: 7px
  &__text
...
@media (min-width: 1200px)
  .product-item
    ...
    &__image
      ...
      &.veg
        &:after
          content: url("~@/assets/img/common/product-veg.svg")
          top: unset
          right: 6px
          bottom: 0
      &.hot
        &:after
          content: url("~@/assets/img/common/product-hot.svg")
          top: unset
          right: 6px
          bottom: 0
    &__text
